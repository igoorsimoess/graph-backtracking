...
- As animações são geradas com `matplotlib.animation` e embutidas como players HTML (`to_jshtml`). Não geram arquivos `.gif` por padrão; se preferir GIFs salvos, dá para trocar por `ani.save("nome.gif", writer="pillow")`.
